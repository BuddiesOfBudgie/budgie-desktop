...
[CCode (cprefix = "Wp", gir_namespace = "wireplumber", gir_version = "0.4", lower_case_cprefix = "wp_")]
namespace Wp {
	...
	public abstract class SiFactory : GLib.Object {
		...
		[CCode (has_construct_function = false)]
		protected SiFactory.simple (string factory_name, GLib.Type si_type);
		public string name { get; construct; }
	}
	...
	public abstract class Transition : GLib.Object, GLib.AsyncResult {
		[CCode (has_construct_function = false)]
		protected async Transition (GLib.Type type, GLib.Object? source_object, GLib.Cancellable? cancellable);
		public void advance ();
		[CCode (has_construct_function = false)]
		protected Transition.closure (GLib.Type type, GLib.Object? source_object, GLib.Cancellable? cancellable, GLib.Closure? closure);
		[NoWrapper]
