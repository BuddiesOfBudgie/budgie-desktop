/* magpie-clutter-11.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "Clutter", gir_namespace = "Clutter", gir_version = "11", lower_case_cprefix = "clutter_")]
namespace Clutter {
	namespace Key {
	...
	[CCode (cheader_filename = "clutter/clutter.h")]
	[Version (replacement = "Color.get_static")]
