/* mutter-cogl-12.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "Cogl", gir_namespace = "Cogl", gir_version = "12", lower_case_cprefix = "cogl_")]
namespace Cogl {
	...
	public class Pipeline : Cogl.Object {
		...
		public void get_layer_filters (int layer_index, Cogl.PipelineFilter min_filter, Cogl.PipelineFilter mag_filter);
	...
	[CCode (cheader_filename = "cogl/cogl.h")]
	[Version (replacement = "Color.equal")]
	...
	[CCode (cheader_filename = "cogl/cogl.h")]
	public static bool is_snippet (void* object);
	[CCode (cheader_filename = "cogl/cogl.h")]
